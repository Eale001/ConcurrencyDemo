package com.eale.spring.scheduled;
...
public class ScheduledTaskService {
    ...
    public void reportTask(){
        System.out.println("五秒执行一次" + FORMAT.format(new Date()));
        System.out.println("时间 ： "+ LocalDateTime.now().toString());
    }

    @Scheduled(fixedDelay = 10000)
    public void delayReportTask(){
        System.out.println("延迟十秒：每隔十秒："+ FORMAT.format(new Date()));
    }
